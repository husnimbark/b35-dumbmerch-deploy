          ...
          {dataContact.map((item) => (
            ...
            >
              <img
                ...
                className="rounded-circle me-2 img-contact rounded rounded-5"
                alt="user avatar"
              />
              <div className="ps-1 text-contact d-flex flex-column justify-content-around rounded rounded-5">
